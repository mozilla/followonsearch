 ...
 * @return {Boolean} Returns true if the profile string is a name.
 */
 ...
 *
 * @param  {String} line The message to check.
 * @return {Boolean} Returns true if it contains an error message.
 */
 ...
 *
 * @param  {String} data The data to analyse
 * @return {Boolean} Returns true if Garbage is found.
 */
 ...
 * @return {Promise} A promise the is resolved when Firefox closes. If there
 *                   is an error, then it is rejected with the error.
 */
